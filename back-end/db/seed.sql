...
('Honey Bun', 1.00, 'Snacks', true, 'imglink', 'Munchies'),
('Sour Power Straws', 1.50, 'Snacks', true, 'imglink', 'Blueberry flavor for the win!'),
('Cry Baby GumBall', 0.45,'Snacks', true, 'imglink', 'Big girls dont cry' ),
('Spicy Doritos', 1.00, 'Snacks', true, 'imglink', 'Nacho Cheese with a little bit of Spice.' ),
