...
('Bacon, Egg, and Cheese', 2.50, 'Sandwich', true, 'https://images.unsplash.com/photo-1494695946268-6222f6246c4e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2089&q=80'),
('Philly-Cheese-Steak', 4.25, 'Sandwich', true, 'https://images.unsplash.com/photo-1600555379885-08a02224726d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80'),
...
('Honey Turkey hero', 4.50, 'Sandwich', true, 'https://images.unsplash.com/photo-1619096534329-564c333a95b3?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c2FuZHdoaWNofGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60'),
...
('5', 'David', 'Cheesy and Yummy', 1),
('6', 'Mr. Mingo', 'NY must have!', 3),
('7', 'Alison','Bacon, Lettuce, Tomato staple', 4),
('8', 'Hannah', 'My fave!', 3),
('9', 'Gabi', 'Munchies', 5),
('10', 'Jon', 'Blueberry flavor for the win!', 5),
('11', 'David', 'Big girls dont cry', 5),
